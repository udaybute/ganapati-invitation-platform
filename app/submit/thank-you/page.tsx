    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-amber-50">
      ...
      {editLink && (
        <div className="mt-4 w-full max-w-sm">
          <p className="text-amber-500 text-xs mb-1">Edit Link (माहिती बदलण्यासाठी — हे खूप महत्त्वाचे आहे, जपून ठेवा):</p>
          <div className="flex items-center gap-2 bg-white border border-amber-400 rounded-xl px-3 py-2">
            <span className="flex-1 font-mono text-xs text-amber-900 truncate">{editLink}</span>
            <CopyButton text={editLink} />
          </div>
          <p className="text-amber-400 text-[11px] mt-2 leading-relaxed">
            ही लिंक कोणाशीही शेअर करू नका — हीच लिंक वापरून तुम्ही भविष्यात तुमची माहिती, फोटो, वेळापत्रक बदलू शकता. लिंक हरवल्यास आमच्याशी संपर्क साधा.
          </p>
        </div>
      )}
