...
const [isPlaying, setIsPlaying] = useState(false);
  ...
  useEffect(() => {
  const audio = new Audio("/audio/ganesh-song.mp3");
...
const toggleMusic = () => {
  ...
  return (
    ...
    >
      ...
      {/* Desktop Background */}
<Image
  src="/images/backgrounds/hero-background-desktop.png"
  alt=""
  fill
  priority
  sizes="100vw"
...
{/* Mobile Background */}
<Image
  src="/images/backgrounds/hero-background-mobile.png"
  alt=""
  fill
  priority
  sizes="100vw"
...
<TempleBell position="right" />
  ...
  <div className="mb-2 flex flex-col items-center">
    <p
      className="mb-1 text-sm font-semibold tracking-wider text-amber-700 sm:text-base md:text-lg"
    >
      ॥ श्री गणेशाय नमः ॥
    </p>
